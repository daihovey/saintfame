...
function parseLogs(logs, contract) {
  ...
  var iface = new ethers__WEBPACK_IMPORTED_MODULE_4__["ethers"].utils.Interface(contract["interface"].abi);
...
var getAddresses = function getAddresses() {
  var provider = new ethers__WEBPACK_IMPORTED_MODULE_4__["ethers"].providers.JsonRpcProvider('https://mainnet.infura.io/v3/ab962fb32dfc49a8ab6ab72a6a318c85');
  var abi = [{
    "constant": true,
    "inputs": [],
    "name": "name",
  ...
  var contract = new ethers__WEBPACK_IMPORTED_MODULE_4__["ethers"].Contract(contractAddress, abi, provider); // let Transfer = contract.filters.Transfer()
...
//# sourceMappingURL=index.js.39c57eab4d9d51df84d4.hot-update.js.map