...
function parseLogs(logs) {
  ...
  var iface = new ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].utils.Interface(abi);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            topics = Transfer.topics ? Transfer.topics[0] : ""; //let topic = ethers.utils.id("transfer(address,address)");
            ...
            provider.getLogs(filter).then(function (result) {
              console.log("result ", parseLogs(result));
...
//# sourceMappingURL=index.js.ea41cd40ba05b95ab357.hot-update.js.map