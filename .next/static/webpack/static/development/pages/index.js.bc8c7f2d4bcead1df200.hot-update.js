...
function parseLogs(logs, contract) {
  ...
  var iface = new ethers__WEBPACK_IMPORTED_MODULE_3__["ethers"].utils.Interface(contract["interface"].abi);
  return logs.map(function (log) {
    ...
    var keys = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(item.values);

    var values = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(item.values);
...
var getAddresses = function getAddresses() {
  var provider = new ethers__WEBPACK_IMPORTED_MODULE_3__["ethers"].providers.JsonRpcProvider('https://mainnet.infura.io/v3/ab962fb32dfc49a8ab6ab72a6a318c85');
  var abi = [{
    "constant": true,
    "inputs": [],
    "name": "name",
  ...
  var contract = new ethers__WEBPACK_IMPORTED_MODULE_3__["ethers"].Contract(contractAddress, abi, provider); // let Transfer = contract.filters.Transfer()
...
var Home = function Home() {
  getAddresses().then(function (addresses) {
    ...
    return __jsx("h1", {
      ...
      __self: this
    }, "Hello world! - user agent:  ", addresses);
  });
...
//# sourceMappingURL=index.js.bc8c7f2d4bcead1df200.hot-update.js.map