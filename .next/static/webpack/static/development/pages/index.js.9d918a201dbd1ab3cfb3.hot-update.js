      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            contract = new ethers__WEBPACK_IMPORTED_MODULE_5__["ethers"].Contract(contractAddress, abi, provider); // let Transfer = contract.filters.Transfer()
            ...
            provider.getLogs(filter).then(function (result) {
              ...
              var log = parseLogs(result, contract); //   for (let entry of result) {
...
//# sourceMappingURL=index.js.9d918a201dbd1ab3cfb3.hot-update.js.map