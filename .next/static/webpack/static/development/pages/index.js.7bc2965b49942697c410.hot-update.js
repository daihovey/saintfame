...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var provider, abi, contractAddress, contract, filter;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            provider = new ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].providers.JsonRpcProvider('https://mainnet.infura.io/v3/ab962fb32dfc49a8ab6ab72a6a318c85');
            abi = [{
              "constant": true,
              "inputs": [],
              "name": "name",
            ...
            contract = new ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].Contract(contractAddress, abi, provider); // let Transfer = contract.filters.Transfer()
            ...
            provider.getLogs(filter).then(function (result) {
              //console.log("result ", parseLogs(result, contract));
              ...
              try {
                for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(logs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  var entry = _step.value;
                  //{_from: "0x0000000000000000000000000000000000000000", _to: "0xd247cf531B9374eB2ba115b68c3b4eBE6C64F5fb"}_from: "0x0000000000000000000000000000000000000000"_to: "0xd247cf531B9374eB2ba115b68c3b4eBE6C64F5fb"__proto__: Object
                  console.log("entry ", entry.values[_to]);
                }
              } catch (err) {
...
//# sourceMappingURL=index.js.7bc2965b49942697c410.hot-update.js.map