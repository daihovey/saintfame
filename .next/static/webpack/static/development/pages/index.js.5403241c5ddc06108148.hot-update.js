...
function parseLogs(logs) {
  var iface = new ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].utils.Interface(new CardsFactory()["interface"].abi);
...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var abi, contractAddress, contract, provider, topic, filter;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // The Contract interface
            abi = ["event ValueChanged(address indexed author, string oldValue, string newValue)", "constructor(string value)", "function getValue() view returns (string value)", "function setValue(string value)"];
            contractAddress = "0xD275B1550E8ca8Da84c552ACa9313Ec4a5B9bD07"; // We connect to the Contract using a Provider, so we will only
            // have read-only access to the Contract

            contract = new ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].Contract(contractAddress, abi, provider);
            ...
            topic = ethers__WEBPACK_IMPORTED_MODULE_6__["ethers"].utils.id("transferFrom(address,address)");
            filter = {
...
//# sourceMappingURL=index.js.5403241c5ddc06108148.hot-update.js.map